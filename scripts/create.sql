...
CREATE TABLE IF NOT EXISTS `test` (
  ...
  `nombre` varchar(120) NOT NULL COMMENT 'Cadena de texto con el nombre',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='Tabla de pruebas';
...
INSERT INTO `test` (`id`, `nombre`, `nota`, `telefono`, `fecha`) VALUES
	(1, 'pepe', 0.5, NULL, '2015-09-01 11:03:10'),
	(2, 'pepa', 7.45, '6666665555444', '2015-09-01 08:30:00'),
	(3, 'juan', 4.55, '9423423', '2015-09-01 13:29:07');
